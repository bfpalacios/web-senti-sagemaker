        ...
        <!--div class="sidebar-brand-icon rotate-n-15">
          <i class="fas fa-laugh-wink"></i>
			...
			<li class="nav-item"><a class="nav-link" href="tables.do"> <i
					class="fas fa-fw fa-table"></i> <span>Análisis de Respuestas
			...
			<li class="nav-item"><a class="nav-link" href="index.do"> <i
					class="fas fa-fw fa-chart-area"></i> <span>Resultado de
						Análisis de Sentimientos</span></a></li>
		...
		<div id="content-wrapper" class="d-flex flex-column">
			...
			<div id="content">
				...
				<div class="container-fluid">
					...
					<div
						class="d-sm-flex align-items-center justify-content-between mb-4">
						<h1 class="h3 mb-0 text-gray-800">Reporte de Análisis de
							Resultados</h1>
								...
								<div class="card-body">
									<div class="row no-gutters align-items-center">
										<div class="col mr-2">
											...
											<div class="h5 mb-0 font-weight-bold text-gray-800">Relación
												con el Equipo</div>
										</div>
									</div>
								</div>
